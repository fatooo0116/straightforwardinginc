...
function why_sec2(){
    vc_map(
        array(
            'name'            => __('Why Section2', 'psky'),
            'base'            => 'why_sec2',
            "category" => array('STRIGHT'),
            'as_parent'               => array('only' => 'why_sec2_item'),
...
add_action( 'vc_before_init', 'why_sec2' );
 ...
 *
 * */
function why_sec2_fun( $atts, $content = null ) {
    ...
    <div id="why_sec2"  class="<?php echo $box_style; ?>">
...
add_shortcode( 'why_sec2', 'why_sec2_fun' );
...
function why_sec2_item(){
  vc_map(
      array(
          'name'            => __('why_sec2 Item', ''),
          'base'            => 'why_sec2_item',
        //  'description'     => __( '分隔區塊', 'eslite' ),
          "category" => array('STRIGHT'),
      //  "icon" => plugins_url('../img/slider.png', __FILE__),
          'as_child'        => array('only' => 'why_sec2'),
          'content_element' => true,
          'params'          => array(
...
add_action( 'vc_before_init', 'why_sec2_item' );
 ...
 *
 */
function why_sec2_item_fun( $atts, $content = null ){
  extract(
      shortcode_atts(
          array(                
              'cimg'=>'',
  ...
  ?>
      ...
      <div class="leader_box">
          <div class="binner">                        
              <div class="pic"  style="background-image:url(<?php echo $cimg[0]; ?>)">                
                <?php  if($cimg[0]){ ?>
...
add_shortcode( 'why_sec2_item', 'why_sec2_item_fun' );
...
if(class_exists('WPBakeryShortCodesContainer')){
  class WPBakeryShortCode_why_sec2 extends WPBakeryShortCodesContainer {
  }
}

// Replace Wbc_Inner_Item with your base name from mapping for nested element
if(class_exists('WPBakeryShortCode')){
  class WPBakeryShortCode_why_sec2_item extends WPBakeryShortCode {
